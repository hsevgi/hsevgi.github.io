...
There is no required textbook for this tutorial. We will read chapters from various books and journal papers which can be accessed through Canvas. You can see the syllabus here. url: [Assets](assets)
